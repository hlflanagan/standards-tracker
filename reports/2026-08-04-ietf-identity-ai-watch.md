...
- **draft-ietf-idr-bgp-ls-sr-epe-over-l2bundle-08** (new-draft, score 0, ignored_after_review) [idr]: [Segment Routing BGP Egress Peer Engineering over Layer 2 Bundle Members](https://datatracker.ietf.org/doc/draft-ietf-idr-bgp-ls-sr-epe-over-l2bundle/) — This document specifies how to support Segment Routing BGP Egress
...
- **draft-vyncke-intarea-legacy-registries-02** (new-draft, score 0, ignored_after_review) [intarea]: [Updates to Legacy IANA Registries](https://datatracker.ietf.org/doc/draft-vyncke-intarea-legacy-registries/) — IANA maintains several registries that were created for IPv4.  As the
