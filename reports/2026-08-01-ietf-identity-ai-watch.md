...
- **draft-melnikov-sasl2-03** (new-draft, score 3, core_identity) [none]: [Extensible Simple Authentication and Security Layer (SASL)](https://datatracker.ietf.org/doc/draft-melnikov-sasl2/) — The Simple Authentication and Security Layer (SASL) is a framework
   ...
   change.
- **draft-norton-sdlp-obj-format-03** (new-draft, score 3, core_identity) [none]: [SDLP Object Format Specification](https://datatracker.ietf.org/doc/draft-norton-sdlp-obj-format/) — This document defines the canonical object format for the Secured
   ...
   This document updates and replaces draft-norton-sdlp-obj-format-02
