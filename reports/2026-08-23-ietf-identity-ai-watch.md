...
- **draft-hawkins-x402-dns-discovery-02** (new-draft, score 0, ignored_after_review) [none]: [Discovering x402 Payment Capability via DNS and a Well-Known URI](https://datatracker.ietf.org/doc/draft-hawkins-x402-dns-discovery/) — x402 is an application-level protocol for internet-native payments
