...
- **draft-dogru-scitt-disclosure-evidence-02** (new-draft, score 7, trust_infrastructure) [none]: [Transformation Evidence and Coverage Reconciliation for Auditable Data Disclosure](https://datatracker.ietf.org/doc/draft-dogru-scitt-disclosure-evidence/) — Audit receipts for automated data access attest to what a gateway
   ...
   counters against a receipt set over a time window and reports
   activity for which no receipt exists.  Both structures are designed
